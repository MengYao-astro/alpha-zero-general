...
# Change otherllo paths to hex paths:
# We try to make changes in such a way that the only things to change is ...
# ... the word `othello' to `hex'. This makes it as straightforward as possible.

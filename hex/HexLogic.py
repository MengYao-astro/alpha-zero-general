...
class Board():
    ...
    # Since, the board is a hexogonal grid, there are 6 neighbours, instead of the 8 with Othello.
    ...
    def __init__(self, n):
        ...
        # With Hex there are no initial pieces so the next lines are commented.
